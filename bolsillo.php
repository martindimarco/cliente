...
<head>
  ...
  <script defer src="./js/bolsillo.js"></script>
  <script defer src="./js/dataTable/bolsilloData_bolsillos.js"></script>
...
<body>
  ...
  <main class="tour_main">
    <div class="container-fluid mt-1 px-0 px-lg-2">
      <div class="card">
        <div class="car-body bg-light p-1">
          <div class="card-text">
            <div class="container-fluid">
              <div class="row justify-content-start">
                <div class="col-12 col-lg-4 align-self-center" id="zonaUC">
            ...
            <!-- g-1 separacion e/lado izq. y der. -->

            <body>
              <div class="container-fluid px-0 px-lg-2">
                <div class="card mt-1 px-0 px-lg-2">
                  <div class="card-body mt-0 pt-0 px-0 px-lg-2">
                    ...
                    <div class="tab-content" id="myTabContent">
                      <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        ...
                        <div class="container-fluid g-1 mt-3">
                          <div class="row g-1">
                            <!-- DERECHA -->
                            <div class="col-12 col-xl-5 mt-0">
                              <div class="card shadow-sm">
                                <!-- paddin de los tres cuadrados de colores -->
                            ...
                            <div class="col mt-3 mt-lg-0">
                              <div class="card tour_tabla_bolsillo">
                                <div class="card-body p-1 shadow-sm">
                                  <div>
                                    <dir class="tbodyDiv p-0 m-0" style="width: 100%;">
                                      <table id="tablaBolsillo" class="table table-sm table-stripped text-center">
                                        <thead class="table-dark sticky-top">
                                          <tr style="font-size: 13px;">
                                            ...
                                            <th>Motivo</th>
                                            <th>Saldo Incial</th>
                                            <th>Llenado en Factura</th>
                                            <th>Uso en Factura</th>
                                            <th>Saldo Final</th>
                                            <th>Excedentes</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          <tr>
                                            <td style="width: 10px;">20/20/24</td>
                                            <td style="width: 10px;">20/20/24</td>
                                            <td style="width: 10px;">20/20/24</td>
                                            <td style="width: 10px;">Ciclo</td>
                                            <td style="width: 10px;">0<span>€ </span></td>
                                            <td style="width: 10px;">10<span>€ </span></td>
                                            <td style="width: 10px;">-10<span>€ </span></td>
                                            <td style="width: 10px;">25<span>€</span></td>
                                            <td style="width: 10px;">150<span>€</span></td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </dir>
                            ...
                            <div class="col mt-0">
                              <div class="card">
                                <div class="card-body shadow-sm p-2">
                                  <div>
                                    <div class="tbodyDiv p-0 m-0" style="width: 100%;">


                                      <table id="tablaExcedentes" class="table table-sm table-stripped text-center">
                                        <thead class="table-dark sticky-top">
                                          <tr style="font-size: 13px;">
                                            <th>Fecha</th>
                                            <th>Desde</th>
                                            <th>Hasta</th>
                                            <th>Consumo de Red</th>
                                            <th>Excedente Producidos</th>
                                            <th>Excedentes</th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          <tr>
                                            ...
                                            <td style="width: 10px;">20/20/24</td>
                                            <td style="width: 10px;">20/20/24</td>
                                            <td style="width: 10px;">168 kWh</td>
                                            <td style="width: 10px;">391.73 kWh</td>
                                            <td style="width: 10px;">28.25€</td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </div>
          ...
          <!-- scr driver.js -->
          <script src="./js/tourBolsillo.js"></script>